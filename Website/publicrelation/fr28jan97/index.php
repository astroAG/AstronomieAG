...
Er ist da, und Guido Kratz hat ihn gesehen. Vom Großen Feldberg aus, mit einem kleinen Feldstecher, um sechs Uhr früh und bei lausiger Kälte. Einen echten Sternengucker ficht das nicht an. Das Objekt seiner Begierde ist fürs bloße Auge derzeit noch ein Knirps: "Wenn man genau hinsieht, erkennt man den Schweif", sagt Guido Kratz und zeigt auf den blassen, irgendwie länglichen Fleck auf seinem Foto. Wenn man sehr genau hinsieht.<br/>
Nachdem er schon im vergangenen Sommer dem Himmel über Deutschland einen kurzen Besuch abstattete, ist der Hale Bopp in den ersten Januartagen wieder aufgetaucht, nach Hyakutake der zweite große Komet innerhalb weniger Monate. Und weil es so trübe ist, dürften ihm außer Guido Kratz noch nicht viele Frankfurter dieser Tage aufs zart milchige Schweiflein geschaut haben.<br/><br/>
Werner Ziegs, Leiter der Astronomie-AG der Liebigschule, ist daher ein bißchen stolz. Der einsatzwillige Hobbyastronom Guido Kratz ist schließlich sein Zögling, auch wenn der 21jährige mittlerweile Wirtschaftsinformatik studiert. "Wer bei uns länger als zwei Jahre dabei ist, bleibt und taucht auch nach dem Abitur immer wieder auf", sagt Werner Ziegs, und die fünf Jungs um ihn herum nicken. 15 gehören derzeit zur AG, die in zwei Gruppen eingeteilt ist. Das hier sind die "Großen".<br/>
Auch Mädchen nehmen teil: "20 Prozent", so formuliert es der Physiker Werner Ziegs. Lehrer ist er nicht. Vor über 20 Jahren, im zweiten Semester, sei er in die AG-Leitung reingerutscht. Weil's ihm Spaß macht, fährt er noch heute jeden Montagabend den weiten Weg von Dieburg zur Sternwarte der Liebigschule, um den Astronomen-Nachwuchs auf den rechten Pfad sorgfältiger Himmelsbeobachtung zu führen.<br/><br/>
Und das ist längst nicht alles: Behruz Kardan, 16 Jahre alt, entwickelt ein Computerprogramm, das künftige Hobbyastronomen in die Geheimnisse des Sternenhimmels einführen kann. Christoph Schneider, ebenfalls 16, betreut die Internet-Seite der AG, die unter anderem mit einem Quiz rund um Mond und Sterne ausgestattet ist. Und der 17jährige Christoph Reeg automatisiert derzeit eine Kleinkamera per Computerprogrammierung: Nachts soll sie dann Himmelsaufnahmen machen und dabei per Zufallsprinzip Meteoritenströme, sprich Sternschnuppen, erwischen, während ihr Besitzer schläft.<br/>
...
<table class="quelle">
    <tr height="58px">
	<td bgcolor="#FFFFFF" width="132px"><img src="FR_logo.gif" alt="Frankfurter Rundschau"/></td>
	<td>Bericht aus der <a href="http://www.fr-online.de" target="_blank">Frankfurter Rundschau</a> vom 28. Januar 1997<br/>Text: Frau Steinburg (ith)
	</td>
    </tr>
    <tr>
	<td colspan="2"><center><i>Mit freundlicher Genehmigung der Frankfurter Rundschau</i></center></td>
    </tr>
</table>
